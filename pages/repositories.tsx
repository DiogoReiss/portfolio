  ...
  return (
    <div className="absolute w-screen h-full left-0 inset-y-0 bg-pink-color mr-1/2">
      ...
      <section className="bg-transparent">
        <h1 className="text-white-color bg-transparent nav-link">Now you can visit my <strong className="text-background-color ml-0 mr-0 bg-transparent nav-link">repositories</strong>.</h1>
